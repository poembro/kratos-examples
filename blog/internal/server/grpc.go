...
func NewGRPCServer(c *conf.Server, logger log.Logger, blog *service.BlogService, articleBiz *biz.ArticleUsecase) *grpc.Server {
...
// grpc游戏端需要验证店铺是否被禁用的接口
func ShopBlacklistByGame() selector.MatchFunc {
